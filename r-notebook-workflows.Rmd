...
- **Working directory** is always document directory (configurable as of RStudio 1.1)
- **Warnings** are not held until the end
- **Console output** is copied into the notebook
- **Plots** and **HTML widgets** are captured into the notebook
